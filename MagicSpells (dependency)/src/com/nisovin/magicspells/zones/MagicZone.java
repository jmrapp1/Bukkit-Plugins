...
public abstract class MagicZone implements Comparable<MagicZone> {
	...
	public ZoneCheckResult check(Location location, Spell spell) {
		if (!inZone(location)) return ZoneCheckResult.DENY;
	...
	@Override
	public int compareTo(MagicZone other) {

...
public abstract class BuffSpell extends TargetedSpell implements TargetedEntitySpell {
	...
	public BuffSpell(MagicConfig config, String spellName) {
		...
		cancelOnChangeWorld = getConfigBoolean("cancel-on-change-world", true);
	...
	public class DamageListener implements Listener {
		...
		public void onPlayerDamage(EntityDamageEvent event) {
			if (MagicSpells.getMagicZoneManager() != null && MagicSpells.getMagicZoneManager().inNoDamageZone(event.getEntity().getLocation())) {
